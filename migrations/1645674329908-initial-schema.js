...
module.exports = class initialSchema1645674329908 {
  name = 'initialSchema1645674329908';

  // async up(queryRunner) {
  //     await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "admin" varchar NOT NULL DEFAULT (1))`);
